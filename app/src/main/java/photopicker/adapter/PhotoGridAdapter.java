...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
  ...
  @Override public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    final View itemView = LayoutInflater.from(parent.getContext()).inflate(me.cl.lingxi.R.layout.__picker_item_photo, parent, false);
  ...
  @Override public void onBindViewHolder(final PhotoViewHolder holder, int position) {
    ...
    if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
      ...
      holder.ivPhoto.setImageResource(me.cl.lingxi.R.drawable.__picker_camera);
    }
  }
  ...
  public static class PhotoViewHolder extends RecyclerView.ViewHolder {
    ...
    public PhotoViewHolder(View itemView) {
      super(itemView);
      ivPhoto   = (ImageView) itemView.findViewById(me.cl.lingxi.R.id.iv_photo);
      vSelected = itemView.findViewById(me.cl.lingxi.R.id.v_selected);
    }
  }
