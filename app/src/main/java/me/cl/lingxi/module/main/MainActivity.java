...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.message_child_fragment);
        btn = findViewById(R.id.send);
        btn.setOnClickListener(new View.OnClickListener() {
                                   @Override
                                   public void onClick(View view) {
                                       Intent intent = new Intent(MainActivity.this, PhotoTest.class);
                                       startActivity(intent);
                                   }
                               });
                mBinding = MianActivityBinding.inflate(
    ...
    private void initBadge() {
        ...
        @SuppressLint("RestrictedApi") BottomNavigationMenuView menuView = (BottomNavigationMenuView) mBinding.bottomNavigation.getChildAt(0);
        @SuppressLint("RestrictedApi") BottomNavigationItemView itemView = (BottomNavigationItemView) menuView.getChildAt(3);
